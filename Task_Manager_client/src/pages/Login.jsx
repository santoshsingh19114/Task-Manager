    ...
    <div className="w-full min-h-screen flex items-center justify-center flex-col lg:flex-row bg-[#f3f4f6]">
      <div className="w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center">
        ...
        <div className="w-full h-full lg:w-2/3 flex flex-col        items-center justify-center">
          <div className="w-full md:max-w-xl 2xl:max-w-3xl flex flex-col item-center justify-center gap-5 md:gap-y-10 2xl:-mt-20">
            <span className="flex gap-1 py-1 px-3 border rounded-full text-sm md:text-base border-gray-300 text-gray-600 text-center mx-auto">
              Manage all your task at one place!
            </span>
            <p className="flex flex-col gap-0 md:gap-4 text-3xl md:text-6xl 2xl:text-7xl text-center font-black text-blue-700">
              <span className="flex flex-col  items-center justify-center gap-y-0">
                Cloud-based
              </span>
